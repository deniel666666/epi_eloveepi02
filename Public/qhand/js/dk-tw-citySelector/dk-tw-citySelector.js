...
;(function($) {
    ...
    $.fn.dk_tw_citySelector = function(selectFirst, selectSecond, selectThird) {
        ...
        var country = [
            ...
            '彰化縣','南投縣','嘉義縣','雲林縣','臺南市','高雄市','澎湖縣',
            '屏東縣','臺東縣','花蓮縣','金門縣','連江縣','南海諸島','釣魚臺列嶼'
        ];
