    ...
    $.fn.gantt = function (options) {
        ...
        var core = {
            ...
            leftPanel: function (element) {
                /* Left panel */
                var ganttLeftPanel = $('<div class="leftPanel"/>').css("width", "340px")
                    .append($('<div class="row spacer"><div class="fat-spacer" style="bottom: 0px;width:100%;position:absolute;"><table style="background-color:#ddd;"><tr><td style="border-right:1px solid #FFF" width="60%">事件主旨</td><td width="35%">執行者</td></tr></table></div></div>')
